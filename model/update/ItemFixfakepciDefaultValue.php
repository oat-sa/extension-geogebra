...
namespace oat\geogebra\model\update;
...
/**
 * Description of ItemFixfakepciDefaultValue
 *
 * @author sam
 */
class ItemFixfakepciDefaultValue extends ItemUpdater
{
    /**
    ...
    protected function updateItem(Item $item, $itemFile)
    {
        ...
        foreach ($interactions as $interaction) {
            if ($interaction instanceof PortableCustomInteraction && $interaction->getTypeIdentifier() === 'fakepciInteraction') {
